...
function Landscape(){
	...
	function setupData() { 
		...
		points.push(new Vector2(260.25, 285.95));
		points.push(new Vector2(260.25, 380.95));	 // new
		points.push(new Vector2(265.95, 380.95));  // new
		...
		availableZones.push(new LandingZone(0, 1));
		availableZones.push(new LandingZone(13, 2));
		availableZones.push(new LandingZone(25, 3));	
		availableZones.push(new LandingZone(34, 4));	
		availableZones.push(new LandingZone(63, 5));	
		availableZones.push(new LandingZone(75, 6));	
		availableZones.push(new LandingZone(106, 7));	
		availableZones.push(new LandingZone(111, 8));	
		availableZones.push(new LandingZone(121, 9));	
		availableZones.push(new LandingZone(133, 10));	
		availableZones.push(new LandingZone(148, 11));	
